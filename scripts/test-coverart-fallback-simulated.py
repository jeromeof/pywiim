...
async def test_coverart_fallback_simulated(ip: str):
    ...
    print(f"\n{'='*70}")
    print(f"🎨 Testing Cover Art Fallback (Simulated No Artwork)")
    print(f"{'='*70}\n")
    ...
    try:
        ...
        try:
            ...
            if result:
                ...
                print(f"     ✅ Default logo can be fetched")
            else:
        ...
        print(f"   - When no artwork in API response, entity_picture = default logo: ✅")
